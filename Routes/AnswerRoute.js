...
import { acceptAnswer2, addAnswer, dislikeAnswer, likeAnswer } from '../Controllers/AnswerController.js'
...
router.post('/:questionId/accept-answer', authUser, acceptAnswer2)
